...
BALL_NEAR         = 500      # "close to ball" threshold
BEHIND_DIST       = 500      # lineup distance behind ball — get well behind before approaching
AVOID_RADIUS      = 650      # swing-around radius — wide arc to approach from directly behind
